...
Full step-by-step guide: [GITHUB_STUDENT_PERK.md](GITHUB_STUDENT_PERK.md)
...
5. Activate GitHub Copilot Pro on your account
...
:::: {.columns}
::: {.column width="100%"}
![GitHub homepage — click "Sign up" in the top-right corner](images/github_studentperk/slide_02.png){width=75%}
:::
::::
...
![GitHub Dashboard — click profile icon, then Settings](images/github_studentperk/slide_03.png){width=70%}
...
![GitHub Settings — click "Password and authentication"](images/github_studentperk/slide_04.png){width=70%}
...
![Enable 2FA — use the same app as Clarku](images/github_studentperk/slide_05.png){width=70%}
...
![GitHub Billing — click Edit on Billing information (no payment needed)](images/github_studentperk/slide_06.png){width=70%}

---

## Step 1d: Get Your Unofficial Transcript

GitHub needs proof you are currently enrolled. Use your **unofficial transcript from CUWeb**.

Log in to CUWeb and go to **Student Records and Registration → Student Profile**.

![CUWeb — click Student Profile under Student Records and Registration](images/github_studentperk/slide_07.png){width=70%}

---

## Step 1d: Unofficial Transcript (cont.)

In your Student Profile, click **Unofficial Academic Transcript** in the left sidebar.

![CUWeb Student Profile — click Unofficial Academic Transcript](images/github_studentperk/slide_08.png){width=70%}
...
![Select "Unofficial Transcript - Web" and click Submit](images/github_studentperk/slide_09.png){width=70%}

---

## Step 1d: Unofficial Transcript (cont.)

Click the **Print** button (top-right) and save as a **PDF file**.

![Click the Print/PDF button to download the transcript](images/github_studentperk/slide_10.png){width=70%}

---

## Step 1d: Unofficial Transcript (cont.)

Make sure your **Spring 2026 courses are listed** before uploading.

![Confirm Spring 2026 courses appear on your transcript](images/github_studentperk/slide_11.png){width=70%}

### Important: GitHub only accepts **image files**, not PDFs.

---

## Step 1d: Prepare Your Transcript Image

Your image must show your **name** and **Spring 2026 enrollment**.

![GitHub requires an image file showing your name and current enrollment status](images/github_studentperk/slide_12.png){width=70%}

---

## Step 1d: Screenshot Option 1

Zoom out in your PDF viewer to display all transcript pages together, then take a screenshot.

![Option 1 — zoom out to show all pages at once and take a screenshot](images/github_studentperk/slide_13.png){width=70%}

---

## Step 1d: Screenshot Option 2

Take separate screenshots of each page, place them side-by-side in PowerPoint or Word, then take a screenshot of the combined view.

![Option 2 — arrange screenshots side-by-side in PPT or Word, then screenshot the whole thing](images/github_studentperk/slide_14.png){width=70%}

Upload this image when GitHub asks for proof of enrollment.

---

## Recommended Folder Structure

For this course, create the following folder to get started:
...
- You can organize the rest however you like
- Avoid spaces in folder/file names (use `_` instead)
- Use a clear hierarchy: General → Subject → Project
...
::: {.column width="50%"}
![Python download page — click the standalone installer link](images/download_python.png){width=100%}
:::
::::

---

## Step 3: Install Python — PATH Checkbox
...
::: {.column width="50%"}
![Check "Add Python 3.14 to PATH" at the bottom before clicking Install Now](images/installation_python.png){width=100%}
:::
::::
...
::: {.column width="45%"}
![Command Prompt showing Python version after a successful install](images/cmd_python.png){width=100%}
:::
::::
...
::: {.column width="50%"}
![Quarto download page — use the current release v1.9.36](images/download_qualto.png){width=100%  fig-alt="Quarto download page"}
:::
::::
