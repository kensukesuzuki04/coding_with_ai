...
| Part | What it does |
|---|---|
| `quarto` | Calls the Quarto program |
| `install` | Downloads and installs something |
| `tinytex` | Lightweight LaTeX engine for PDF output |

> Quarto handles the download automatically. May take a few minutes.
