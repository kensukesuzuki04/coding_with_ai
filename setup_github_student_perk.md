...
![GitHub Dashboard — click your profile icon, then select Settings](images/setup_github_student_perk/slide_03.png)

In Settings, scroll down on the left sidebar and click **Password and authentication**.

![GitHub Settings — click "Password and authentication" in the left sidebar](images/setup_github_student_perk/slide_04.png)
...
![GitHub Billing — click Edit on Billing information (no payment required)](images/setup_github_student_perk/slide_06.png)
...
![CUWeb — click Enrollment Verification under Student Records and Registration](images/setup_github_student_perk/slide_07.png)
...
![Current Enrollment Verification Certificate — take a screenshot to upload to GitHub](images/setup_github_student_perk/slide_08.png)
