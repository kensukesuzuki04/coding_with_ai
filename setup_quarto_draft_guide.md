...
```html
<a href="https://github.com/kensukesuzuki04/coding_with_ai/blob/main/setup_pre_course_preparation.md" target="_blank" rel="noopener noreferrer">See the setup guide</a>
```
